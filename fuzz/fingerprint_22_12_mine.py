...
"""δ — extract the (22,12) source fingerprint, the 4th green-zone candidate.

Symmetric counterpart to α (10,10): right-side interior, no chip edges.
If the interior-symmetry hypothesis holds, fingerprint should look similar
in size and type distribution to α.
"""
