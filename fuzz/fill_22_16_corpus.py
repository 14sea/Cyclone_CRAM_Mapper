...
"""θ step 1 — fill the (22,16) Y=15-adjacent (one row below ghost row) corpus.

Sixth green-zone candidate. (22,16) is Y=15-adjacent (one row below ghost row), complementing the
...
(22,16) is a clean interior LAB with no M9K boundary, no corner.
"""
import sys, os
