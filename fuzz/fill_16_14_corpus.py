...
"""η step 1 — fill the (16,14) Y=15-adjacent (one row above ghost row) corpus.

Sixth green-zone candidate. (16,14) is Y=15-adjacent (one row above ghost row), complementing the
