...
"""Build the w=4 depth=2048 M9K_MODE goldintersect HW probe by
...
Only delta vs HW-PASS RBF: sym_diff(w9x512_gi, w4x2048_gi) = 62 cells
(disjoint gi buckets: 38 OFF + 24 ON).
"""
...
OUT = HERE / "simple_led_m9k_mode_w4x2048_goldintersect_HWbase.rbf"
