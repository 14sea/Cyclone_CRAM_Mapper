...
"""Build the w=36 depth=256 M9K_MODE goldintersect HW probe by
...
Only delta vs HW-PASS RBF: sym_diff(w9x512_gi, w36x256_gi) = 49 cells
(disjoint gi buckets: 38 OFF + 11 ON).
"""
...
OUT = HERE / "simple_led_m9k_mode_w36x256_goldintersect_HWbase.rbf"
