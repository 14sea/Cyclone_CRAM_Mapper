...
16. **γ X=4 cross-LAB — 1-input bypass + 2-input canon BOTH CLOSED 2026-05-13 at X4Y4N0.**
    ...
    - **Pivot guidance (updated 2026-05-13)**: at X4Y4N0, asymmetric masks (e.g. 0x4444, 0xBBBB, 0xA0A0) are codec-supported via `canon_2input_aware=True`. Other X=4 src-LE positions (Y∈{2,7,17,21}) still require symmetric 0x6996 workaround OR per-position canon-2input mining. **N>0 invariance** (P4 axis) silicon spot-check pending.
    Test fixture: `scripts/sigcache_validation/build_test.py`. Memos: `gamma_*`, `iob_route_hdr_skip_pivot_2026_05_11`, `sigma_inv_x4y4n0_not_a_4perm_2026_05_12`, `phase3_canon_cell_codec_landed_2026_05_13`, `phase4_bypass_tt_model_2026_05_13`, `p1_bypass_aware_silicon_validated_2026_05_13`, `p2_canon_2input_silicon_validated_2026_05_13`, `phase4_p1_p5_landed_2026_05_13`.
