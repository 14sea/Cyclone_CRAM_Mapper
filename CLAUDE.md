...
| `IOB_ROUTE` | `IOB_ROUTE PIN_E16 -> X10Y4N0.dataa` | OK — pin→LE-port sig lookup (pair-template deltas). CRAM band bit-perfect vs HW-verified `iob_pair_E16_10_4_0_dataa.rbf`. |
