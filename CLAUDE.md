...
| `LAB_CLK_SEL` | `LAB_CLK_SEL X10Y4` | OK — per-LAB CLK_SEL (XOR). 13 LABs mined (cell counts 21..53). Re-mine with `fuzz/clk_lab_sel_probe.py --lab X,Y`. Cross-LAB audit: `fuzz/clk_lab_sel_full_audit.py`. |
